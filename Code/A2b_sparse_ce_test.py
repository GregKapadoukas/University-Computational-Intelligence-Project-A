...
sensor_classes = df['Class'].map({'sitting':1, 'sittingdown':2, 'standing':3, 'standingup':4, 'walking':5})
sensor_classes
...
#sensor_measurements['Class'] = sensor_measurements['Class'].map({'sitting':1, 'sittingdown':2, 'standing':3, 'standingup':4, 'walking':5})
sensor_measurements
